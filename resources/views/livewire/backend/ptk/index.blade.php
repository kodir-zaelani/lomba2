            ...
            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                <div class="box box-bordered border-primary">
                    <div class="box-header with-border">
                        ...
                        <a  href="{{ route('backend.pegawai.create') }}" class="btn btn-success btn-sm ms-3" title="Add New"> <i class="fa fa-plus me-2" aria-hidden="true"></i> Add</a>
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="@if ($this->isChecked($item->id))
                                                ...
                                                <td class="text-center align-midle">
                                                    ...
                                                    @endif
                                                    @endif
                                                    <a href="{{ route('backend.pegawai.edit', $item->id) }}" class="btn btn-xs btn-warning">

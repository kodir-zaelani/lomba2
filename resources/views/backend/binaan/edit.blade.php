...
<div class="content-header">
    <div class="d-flex align-items-center">
        ...
        <section class="content">
            <form id="post-form" enctype="multipart/form-data" action="{{ route('backend.binaan.update', $spbinaan) }}"
            method="POST">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-lg-8 col-12">
                    <div class="box">
                        <div class="box-header">
                            <h4 class="box-title">Edit a Pendampingan
                            </h4>
                        </div>
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-lg-8 col-md-8 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            value="{{ old('strategi') ?? $spbinaan->strategi}}" placeholder="Title" required>
                                        </div>
                                        @error('strategi')
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    ...
                                    value="{{ old('lingkup_pembahasan') ?? $spbinaan->lingkup_pembahasan}}" placeholder="Title" required>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                name="program_kerja" required>{{ old('program_kerja') ?? $spbinaan->program_kerja}}</textarea>
                                @error('program_kerja')
                                <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                name="kelebihan" required>{{ old('kelebihan') ?? $spbinaan->kelebihan}}</textarea>
                                @error('kelebihan')
                                <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                name="umpan_balik" required>{{ old('umpan_balik') ?? $spbinaan->umpan_balik}}</textarea>
                                @error('umpan_balik')
                                <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                name="perubahan" required>{{ old('perubahan') ?? $spbinaan->perubahan}}</textarea>
                                @error('perubahan')
                                <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                name="rencana_perbaikan" required>{{ old('rencana_perbaikan') ?? $spbinaan->rencana_perbaikan}}</textarea>

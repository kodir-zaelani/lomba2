                    ...
                    <nav>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('backend.dashboard') }}"><i
                                ...
                                <li class="breadcrumb-item" aria-current="page">Dukungan</li>
                    ...
                    <div class="box box-bordered border-primary">
                        <div class="box-header with-border">
                            ...
                            <div class="box-controls pull-right">
                                <a class="btn btn-sm btn-primary" href="{{ route('backend.dukungan.create') }}">
                                    <i
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <tbody>
                                        @foreach ($datadukunganall as $no => $item)
                                        <tr class="@if ($this->isChecked($item->id)) table-primary @endif">
                                            <th class="text-right" scope="row">
                                                {{ $no + $datadukunganall->firstItem() }}</th>
                                                <td>
                                                ...
                                                <td class="text-center align-midle">
                                                    ...
                                                    href="{{ route('backend.dukungan.edit', $item->id) }}">
                            ...
                            <div class="mt-3 row">
                                <div class="col-xl-12 col-md-12 col-lg-12 col-12 text-start small text-muted">
                                    @if ($datadukunganall->total() > 10)
                                    {{ $datadukunganall->links() }}
                                    @else
                                    Page : {{ $datadukunganall->currentPage() }} | Show {{ $datadukunganall->count() }} data
                                    of {{ $datadukunganall->total() }}
                                    @endif
                                </div>
                            </div>
                            @else
